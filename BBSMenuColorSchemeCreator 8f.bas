...
PRINT "%                                                                              %"
LOCATE 14, 24
PRINT "%                Alpha    Version 8.04f Release Candidate--RC8                 %"
LOCATE 15, 24
PRINT "%                                                                              %"
LOCATE 16, 24
...
CLS
PRINT
PRINT "BBS Menu Color Scheme Creator 8.04f Alpha Version RC8"
PRINT "Written by Russ Campbell Updated September 7 2020"
PRINT
...
IF colordisplay = "C" OR colordisplay = "W" OR colordisplay = "L" THEN GOTO menu
GOTO charactercode
    ...
    FOR i = 1 TO LEN(lnumber)
        ...
        IF display = "pcb" THEN
            ...
            ELSEIF flag$ = "Y3" THEN
                ...
                PRINT #2, backgroundcoloransi + foregroundcolorpcb + c$;
                PRINT c$;
            END IF
        ELSE
            c$ = b
...
PRINT
PRINT "Thank you for using BBS Menu Color Scheme Creator 8.0b RC8."
PRINT
END
pick:
RANDOMIZE TIMER
